//
//  CPNHomePageGoodsItemTableViewCell.m
//  MarketO2O
//
...
@implementation CPNHomePageProductItemTableViewCell
...
- (void)layoutSubviews{
    ...
    self.buyButton.right = self.cellBackView.width - 10;
    self.buyButton.bottom = self.itemImageView.bottom;
    
    self.itemPointsLabel.left = self.itemNameLabel.left;
    self.itemPointsLabel.bottom = self.buyButton.bottom;
    self.itemPointsLabel.width = self.buyButton.left - self.itemPointsLabel.left - 10;
}
