...
- (UISearchController *)searchController {
    if (_searchController == nil) {
        ...
        [_searchController.searchBar setBackgroundImage:[UIImage createImageWithColor:CPNCommonMaxLightGrayColor] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault]; // 替换系统的背景图片
...
//        [_searchController.searchBar setImage:[UIImage new] forSearchBarIcon:UISearchBarIconSearch state:UIControlStateNormal]; // 可以替换放大镜，删除图片等图片
        _searchController.searchBar.placeholder = @"商品搜索";
...
- (void)searchBarSearchButtonClicked:(UISearchBar *)searchBar {
    ...
    [[CPNHTTPClient instanceClient] requestSearchProductWithKeyString:searchBar.text completeBlock:^(NSArray *searchProductList, CPNError *error) {
        [self.resultVC updateSearchResults:searchProductList];
    }];
}
...
- (void)searchBarCancelButtonClicked:(UISearchBar *)searchBar {
    [self.resultVC updateSearchResults:nil];
}
@end
// ===============================================================================================================================================================================
