...
@interface ShowImagesFullScreen()
...
@implementation ShowImagesFullScreen

+ (ShowImagesFullScreen*)shareShowImagesFullScreenManager
{
    static dispatch_once_t once;
    static ShowImagesFullScreen *shareInstance = nil;
    dispatch_once(&once, ^{
        
        if (!shareInstance) {
            shareInstance = [[ShowImagesFullScreen alloc] init];
        }
    });
